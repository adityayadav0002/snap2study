...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    async function loadProfile() {
      try {
        ...
        console.error( "[Snap2Study] Profile load failed:", err
        );
  ...
  async function handleSubmit(
    ...
    try {
      ...
      console.error( "[Snap2Study] Profile update failed:", err );
      ...
      <header className="border-b-2 border-black">
        <div className="container flex min-h-20 items-center justify-between">
          ...
          <a
            href="/"
            className="
              mono border-2 border-black px-4 py-3 text-[9px] font-black
              uppercase tracking-[0.12em] transition-colors hover:bg-black hover:text-(--cream)
            ">
            ← Home
          </a>
        ...
        <div className="max-w-3xl">
          ...
          <div className="border-2 border-black bg-(--paper) p-6 shadow-[6px_6px_0_var(--black)] sm:p-10">
            <form onSubmit={handleSubmit} className="space-y-8" >
              ...
              <div>
                <label htmlFor="email" className="mono mb-3 block text-[9px] font-black uppercase tracking-[0.15em]">
                  Email
                </label>
                ...
                <input
                  ...
                  disabled
                  className="
                    w-full border-2 border-black bg-gray-100 px-4 py-4 text-sm opacity-70 outline-none
                  "/>
              ...
              <div>
                <label htmlFor="name" className="mono mb-3 block text-[9px] font-black uppercase tracking-[0.15em]">
                  Name
                </label>
                ...
                <input
                  ...
                  className="
                    w-full border-2 border-black bg-(--cream) px-4 py-4 text-sm outline-none transition-shadow focus:shadow-[4px_4px_0_var(--yellow)]
                  "/>
              </div>
              ...
              <button
                ...
                disabled={saving}
                className="
                  brutal-border w-full bg-(--yellow) px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] shadow-[4px_4px_0_var(--black)] transition-all hover:-translate-x-0.5 
                  hover:-translate-y-0.5 hover:shadow-[6px_6px_0_var(--black)] active:translate-x-0 active:translate-y-0 active:shadow-none disabled:cursor-not-allowed disabled:opacity-50
                ">
                {saving
                  ? "Saving..." : "Save changes"}
              </button>
          ...
          <div className="mt-16 border-t-2 border-black pt-10">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between"> 
              ...
              <a
                href="/history"
                className="
                  mono inline-flex w-fit items-center gap-3 border-2 border-black bg-(--yellow) px-5 py-3 text-[9px] font-bold uppercase tracking-[0.12em] 
