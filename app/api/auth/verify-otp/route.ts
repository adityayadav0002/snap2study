...
import { createSession, hashOtp, isValidEmail, normalizeEmail, } from "@/lib/auth";
...
export async function POST( request: Request) {
  try {
    ...
    if (
      !body || typeof body.email !== "string" || typeof body.otp !== "string"
    ) {
    ...
    console.error("[Snap2Study] OTP verification error:", error );
